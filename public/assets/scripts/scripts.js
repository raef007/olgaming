(function() {
     ...
     */
    $(".left-side-inner").niceScroll({styler:"fb",cursorcolor:"#27cce4", cursorwidth: '3', cursorborderradius: '10px', background: '#424f63', spacebarenabled:false, cursorborder: '0'});

    $(".left-side-inner").getNiceScroll();
    if ($('body').hasClass('left-side-collapsed')) {
        $(".left-side-inner").getNiceScroll().hide();
    }
   ...
   jQuery('.menu-list > a').click(function() {
      ...
      $(".left-side-inner").getNiceScroll().resize()
      return false;
   });
